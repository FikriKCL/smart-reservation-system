...
class _BookmarkScreenState extends State<BookmarkScreen> {
  ...
  List<Court> get _saved => kCourts.where((c) => widget.bookmarks.contains(c.id)).toList();
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Text(
                    'My Bookmarks',
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: kSlate800),
                  ),
                  const Spacer(),
                  Container(
              ...
              child: saved.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: const [
                          Icon(Icons.bookmark_border, size: 64, color: kSlate400),
                          SizedBox(height: 16),
                          Text(
                            'No bookmarks yet',
                            style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: kSlate500),
                          ),
                          SizedBox(height: 6),
                          Text(
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (_, i) => CourtGridCard(
                        court: saved[i],
                        bookmarked: true,
                        onToggleBookmark: () => setState(() => _confirm = saved[i]),
                        onTap: () => widget.onOpenCourt(saved[i]),
                      ),
                    ),
            ),
          ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: kSlate800),
                        ),
